...
func TestCalcFuelDay2_1(t *testing.T) {
	mass := 12
	fuel := CalcFuel(mass)
	if fuel != 2 {
...
func TestCalcFuelDay2_2(t *testing.T) {
	mass := 14
	fuel := CalcFuel(mass)
	if fuel != 2 {
		t.Errorf("Fuel was incorrect, got: %d, want: %d.", fuel, 2)
...
func TestCalcFuelDay2_3(t *testing.T) {
	mass := 1969
	fuel := CalcFuel(mass)
	if fuel != 654 {
...
func TestCalcFuelDay2_4(t *testing.T) {
	mass := 100756
	fuel := CalcFuel(mass)
	if fuel != 33583 {
...
func TestCalcFuelDay2_5(t *testing.T) {
